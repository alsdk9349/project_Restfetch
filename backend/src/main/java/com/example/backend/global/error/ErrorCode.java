...
public enum ErrorCode {
    ...
    //Fetch
    FETCH_DUPLICATED(HttpStatus.CONFLICT, "F001", "이미 등록된 기기입니다."),
    FETCH_NOT_FOUND(HttpStatus.NOT_FOUND, "F002", "등록된 기기가 없습니다."),


    //Observer
    OBSERVER_DUPLICATED(HttpStatus.CONFLICT, "O001", "이미 등록된 기기입니다.");
